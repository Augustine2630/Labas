...
public class DatabaseHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + DBContract.DBEntry.TABLE_NAME + "(" + DBContract.DBEntry.COLUMN_NAME_ID
        ...
        values.put(DBContract.DBEntry.COLUMN_NAME_ADDRESS, "улица 1");
        values.put(DBContract.DBEntry.COLUMN_NAME_DATE, "04-01-2077");
